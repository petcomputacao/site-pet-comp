...
import './mapaCampusPersonalizado.css';

export default function MapaCampusPersonalizado() {
    ...
    const pinImage = process.env.PUBLIC_URL + '/images/pin.png';
    ...
    }, [ufcg.lng, ufcg.lat, zoom, geoData, pinImage]);
