import "../../styles/sobre/SecaoSobreDireita.css"
...
export default function SobreDireita(){
    return(
        <div className="functionPAISobreDireita">
            ...
            {/*bloco animado dos pilares do PET (ensino, pesquisa e extensão)*/}
            <div className="block">
                <div className="container-vertentes">
                    <div className="container-pesquisa">
                        <h2>ENSINO</h2>
                            <p>
                            Os integrantes do PET Computação atuam fortemente no âmbito de ensino na universidade, podendo participar como colaboradores de monitoria e fornecendo minicursos para toda a graduação.                   
                            </p>
                    </div>
                    <div className="container-extensao">
                        <h2>PESQUISA</h2>
                            <p>
                                Todos os integrantes do PET Computação participam de algum projeto de pesquisa junto a um professor coordenador da nossa universidade buscando trazer informação e inovação.
                            </p>
                    </div>
                    <div className="container-tutoria">
                        <h2>EXTENSÃO</h2>
                            <p>
                                O grupo PET Computação fornece apoio na área de informática para toda a comunidade de Campina Grande, principalmente atuando nas escolas públicas de Ensino Médio da nossa cidade.
                            </p>
                    </div>
                </div>
            </div>
            ...
            <div className="block-inferior">
                <div className="redes-sociais-frase">
                    <p>
                        Confira nossas atividades nas redes sociais!
                    </p>
                </div>
